...
abstract class BasePost
{
     ...
     * @ODM\ReferenceOne(targetDocument="Discutea\DForumBundle\Entity\Topic", name="topic_id", inversedBy="posts")
     */
    protected $topic;
     ...
     * @ODM\ReferenceOne(targetDocument="\Tyras\UserBundle\Entity\User", name="updated_by")
     */
    protected $updatedBy;
