...
abstract class BaseForum
{
     ...
     * @ODM\Field(name="disp_position", type="int")
     */
     ...
     * @ODM\ReferenceOne(targetDocument="Discutea\DForumBundle\Entity\Category", name="category_id", inversedBy="forums")
     */
    protected $category;
     ...
     * @ODM\ReferenceMany(targetDocument="Discutea\DForumBundle\Entity\Topic", mappedBy="forum", cascade={"persist", "remove"}, sort={"pinned": "desc", "lastPost": "desc"})
     */
    protected $topics;
