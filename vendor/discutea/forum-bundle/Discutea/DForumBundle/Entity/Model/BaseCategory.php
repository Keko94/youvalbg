...
abstract class BaseCategory 
{
     ...
     * @ODM\ReferenceMany(targetDocument="Discutea\DForumBundle\Entity\Forum", mappedBy="category", cascade={"persist", "remove"}, sort={"position": "asc"})
     */
    protected $forums;
     ...
     * @ODM\Field(name="read_authorised_roles", type="string")
     */
